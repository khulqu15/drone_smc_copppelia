...
def visualize_data(data, fault_mask, motor_faults):
    ...
    for i, col in enumerate(columns):
        ...
        for idx, is_fault in fault_mask[actual_col].iteritems():
            if is_fault:
                plt.scatter(idx, data[actual_col][idx], color='red')
                for motor, affected in motor_faults.items():
                    if affected and actual_col in motor_influence[motor]:
                        plt.text(idx, data[actual_col][idx], motor_labels[motor], color='red')
