...
dt = 0.01
tfinal = 100
amplitude = 2  # Amplitude dari square wave
frequency = 1  # Frekuensi dari square wave (dalam Hz)
...
for i in range(n):
    ...
    error = np.random.uniform(-0.5, 0.5) * amplitude * 0.5  # Error acak 25% dari amplitude
