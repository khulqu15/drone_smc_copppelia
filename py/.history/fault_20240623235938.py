...
def generate_drone_dataset(num_entries=100):
    np.random.seed(42)
    mm_size = np.random.randint(1000, 1100, size=num_entries)
    phi = np.random.randint(-5, 5, size=num_entries)
    theta = np.random.randint(-5, 5, size=num_entries)
    phi_dot = np.random.uniform(-35, 35, size=num_entries)
    theta_dot = np.random.uniform(-35, 35, size=num_entries)
    ze = np.random.uniform(3.0, 4.0, size=num_entries)
    rpm = np.random.randint(1000, 3000, size=num_entries)
