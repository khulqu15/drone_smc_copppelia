    ...
    for i, col in enumerate(columns):
        ...
        if motor_faults is not None:
            for motor, faults in motor_faults.items():
                ...
                plt.scatter(data.index[motor_fault_indices], data[actual_col][motor_fault_indices], label=f'Fault {motor}', s=20, edgecolors=motor_colors[motor], facecolors='none', zorder=3)
