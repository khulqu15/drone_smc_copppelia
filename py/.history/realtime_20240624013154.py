...
# Menghasilkan square wave dan menambahkan noise pada titik-titik perpindahan amplitude
for i in range(n):
    if 80 <= i <= 90:  # Kondisi khusus untuk iterasi ke-80an
        current_amplitude = amplitude * 0.5  # Amplitude 50% lebih kecil
