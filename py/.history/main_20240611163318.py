...
def main():
    ...
    if data is not None:
        ...
        orientation_and_z = data[['Roll', 'Pitch', 'Yaw', 'Z']].to_numpy()
        ...
        labels = ['Roll', 'Pitch', 'Yaw', 'Z']
        for i, ax in enumerate(fig.get_axes()):
            ax.set_title(labels[i % 4] + ' to ' + labels[i // 4])
        plt.show()
        ...
        printcipalComponents = pca.fit_transform(orientation_and_z)
